...
The request Body is a [Trip](/Resources/Trip) object with the [Stop](/Resources/Stop) object inserted into the **route.stops** Array. Please note that modifying any of the other fields, should return an error response.
