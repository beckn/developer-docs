...
|-----------------------|-----------|-----------------------|
| Final Mile Delivery   |  0.6.0    |    02 June, 2020      |
| Food and Beverage     |  0.4.0    |    02 June, 2020      |
| Mobility              |  0.7.4    |    02 June, 2020      |
| Final Mile Delivery   |  0.5.1    |    21 May, 2020       |
| Core                  |  0.8.0    |    21 May, 2020       |
| Healthcare            |  0.5.0    |    02 May, 2020       |
| Food and Beverage     |  0.3.1    |    22 April, 2020     |
| Core                  |  0.7.1    |    17 April, 2020     |
| Mobility              |  0.7.1    |    09 December, 2019  |
| Mobility              |  0.5.3    |    30 October, 2019   |
...
Beckn is a protocol, not a platform. It adopts a decentralized architecture that obviates the need for creating a centralised platform in order to integrate services from multiple providers.
