...
Confirm the FMD Order. Using this action, the FMD Payer should also be able to send proof of payment to the FMD service
...
```json
{
  "context": {
    ...
    "session_id": "string",
    "timestamp": "2020-07-08T07:51:12.584Z",
    "token": "string",
    "status": "string"
  },
  "message": {
